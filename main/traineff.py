...
# Build the Network11111
mbllen = Network1.build_mbllen(crop_shape)
...
vgg = Network1.build_EfficientNet()
vgg.trainable = False
...
class Show_History(keras.callbacks.Callback):
    ...
    def on_epoch_end(self, val_loss=None, logs=None):
        ...
        global mbllen
        num_epoch += 1
        modelname = './models/' + str(num_epoch) + '_' + dataset_name + '_base1.h5'
    ...
    def on_batch_end(self, batch, logs={}):
        ...
        fileObject = open("./trainList1.txt", 'a')
